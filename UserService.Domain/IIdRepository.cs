...
namespace IdentityService.Domain
{
    public interface IIdRepository
    {
        ...
        Task<List<User>> FindUsersById(List<long> ids);
        Task<User?> FindByEmialAsync(string emial);//根据邮箱查找
        /// <summary>
        /// 生成重置密码的令牌
        /// </summary>
        ...
        /// <returns></returns>
        Task<IdentityResult> ChangePasswordAsync(long userId, string password);
